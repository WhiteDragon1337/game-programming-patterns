...
The scripting system I wrote for [*Henry Hatsworth and the Puzzling Adventure*]
(http://en.wikipedia.org/wiki/Henry_Hatsworth_in_the_Puzzling_Adventure) worked
like this.
